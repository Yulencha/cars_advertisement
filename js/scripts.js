    ...
    <div class="offer__wrap">
        ...
        <div class="offer__info">
          <div class="offer__title">
            GEELY <span style="color: #002d96"><b>${data[index].car_model}</b></span>
          </div>

          <div class="offer__benefit">
            <div class="offer__benefit_wrap">
              ВЫГОДА ДО <span class="offer__benefit_large"> ${data[index].benefit}</span>
            </div>
          </div>
          ...
          <div class="offer__block">
            <div class="offer__item">
              ...
              <div class="offer__text">
                ...
                <span class="offer__text_large">${data[index].trade_in}</span>
              </div>
            </div>
            <div class="offer__item">
              ...
              <div class="offer__text">
                ...
                <span class="offer__text_large">${data[index].credit}</span>
              </div>
            </div>
          </div>
          <div class="offer__block">
